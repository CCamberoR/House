...
class Chatbot:
    ...
    def chat2(self, query: str, lang: str = 'english', top_k: int = 3, device_setup = "auto"):
...
def main():
    ...
    st.title("HOUSE")
    st.write("Bienvenido. Soy H.O.U.S.E (Health Observation, Understanding, and Symptom Evaluation). Te proporciono información basada en consultas médicas realizadas por profesionales.  **No sustituyo a un profesional médico. De hecho, por mi nombre deberías saber ya que tienes lupus.**")
